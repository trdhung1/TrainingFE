...
function ModalCreate(props: any) {
    ...
    const {selectedEmployee, setSelectedEmployee, isOpenCreateOrUpdate, handleToggleModal} = props;
    ...
    <div className="modal-create">
        <Modal
            title={selectedEmployee && JSON.stringify(selectedEmployee) !== '{}'? 'Update employee' : 'Create a new employee'}
